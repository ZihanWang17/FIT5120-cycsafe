...
export default function PlanRoutePage() {
  return (
    <main className="plan-route-page">
      <section className="card" style={{ display: "grid", placeItems: "center", minHeight: 240 }}>
        <div style={{ fontSize: "1.8rem", fontWeight: 800, textAlign: "center" }}>
          Feature coming soon, <span style={{ color: "#2563eb" }}>STAY TUNED!</span>
        </div>
      </section>
    </main>
  );
